...
NUM_EPOCHS=50
DROPOUT_RATE=0.3    # Dropout rate to use (default is 0.1)
WEIGHT_DECAY=0.00001     # Weight decay value for optimizer (default is 0.00001)
N_HEAD=12
THRESHOLD=0.8
OPTIMIZER=AdamW
...
CMD="python train_no_dm.py \"$MODEL_NAME\" \"$SAVE_DIR\" $OUTPUT_DIM $NUM_BLOCKS $BATCH_SIZE $LEARNING_RATE $NUM_EPOCHS $N_HEAD $THRESHOLD $OPTIMIZER"
